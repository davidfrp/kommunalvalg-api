INSERT INTO parties (signature, abbreviation, name, hex_color) VALUES
    ('A', 'S', 'Socialdemokratiet', '#b50f05'),
    ('B', 'RV', 'Radikale Venstre', '#7d1f91'),
    ('C', 'KF', 'Det Konservative Folkeparti', '#A6CC05'),
    ('D', 'NB', 'Nye Borgerlige', '#008c8c'),
    ('E', null, 'Christiania-Listen', '#b2b2b2'),
    ('F', 'SF', 'Socialistisk Folkeparti', '#f578b0'),
    ('G', null, 'Veganerpartiet', '#beaa64'),
    ('H', null, 'Grøn Omstilling', '#b2b2b2'),
    ('I', 'LA', 'Liberal Alliance', '#24c7d6'),
    ('J', null, 'Hampepartiet', '#b2b2b2'),
    ('K', 'KD', 'Kristendemokraterne', '#8c826e'),
    ('L', null, 'Københavnerlisten', '#b2b2b2'),
    ('M', null, 'Danmark for Alle', '#b2b2b2'),
    ('N', null, 'Kommunisterne', '#b2b2b2'),
    ('O', 'DF', 'Dansk Folkeparti', '#f6cd03'),
    ('P', null, 'Copenhagen', '#b2b2b2'),
    ('Q', null, 'Feministisk Initiativ', '#b2b2b2'),
    ('R', null, 'Kommunistisk Parti', '#b2b2b2'),
    ('T', null, 'Frihedslisten', '#b2b2b2'),
    ('U', null, 'Klimapartiet Momentum', '#b2b2b2'),
    ('V', 'V', 'Venstre, Danmarks Liberale Parti', '#1a406e'),
    ('Y', null, 'Kærlighedspartiet', '#b2b2b2'),
    ('Z', null, 'Rolig Revolution', '#b2b2b2'),
    ('Æ', null, 'Bæredygtigt samfund', '#b2b2b2'),
    ('Ø', 'EL', 'Enhedslisten - De Rød-Grønne', '#ff8200'),
    ('Å', 'ALT', 'Alternativet', '#1a9629'),
    ('01', null, 'Det Demokratiske Parti', '#b2b2b2');
